var linkControl = {
    run:function(spawn){
        ...
        if(a_spawn.room.storage){
        
            var all_links = r_storage.room.find(FIND_MY_STRUCTURES, {filter: {structureType: STRUCTURE_LINK}});
    
    
            
            if(r_storage != undefined && all_links.length >= 2){
